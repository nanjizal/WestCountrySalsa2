...
Main.main = function() {
	...
	Main.resize = function() {
		...
		Main.wid = canvas.width / 2 | 0;
		Main.hi = canvas.height / 2 | 0;
		canvas.style.width = document.documentElement.clientWidth + "px";
		canvas.style.height = document.documentElement.clientHeight + "px";
	};
	$window.onresize = Main.resize;
	Main.resize();
	kha_System.init({ title : "West Country Salsa", width : 1024, height : 768, samplesPerPixel : 4},function() {
		new westCountrySalsa_WestCountrySalsa2();
	});
};
Math.__name__ = ["Math"];
...
kha__$Assets_ImageList.prototype = {
	...
	,westCountrySalsa2icon2Load: function(done) {
		kha_Assets.loadImage("westCountrySalsa2icon2",function(image) {
			done();
		});
	}
	,westCountrySalsa2icon2Unload: function() {
		this.westCountrySalsa2icon2.unload();
		this.westCountrySalsa2icon2 = null;
	}
	,names: null
...
var simpleText_HAlign = $hxClasses["simpleText.HAlign"] = { __ename__ : true, __constructs__ : ["LEFT","RIGHT","CENTRE","JUSTIFY"] };
simpleText_HAlign.LEFT = ["LEFT",0];
simpleText_HAlign.LEFT.toString = $estr;
simpleText_HAlign.LEFT.__enum__ = simpleText_HAlign;
simpleText_HAlign.RIGHT = ["RIGHT",1];
simpleText_HAlign.RIGHT.toString = $estr;
simpleText_HAlign.RIGHT.__enum__ = simpleText_HAlign;
simpleText_HAlign.CENTRE = ["CENTRE",2];
simpleText_HAlign.CENTRE.toString = $estr;
simpleText_HAlign.CENTRE.__enum__ = simpleText_HAlign;
simpleText_HAlign.JUSTIFY = ["JUSTIFY",3];
simpleText_HAlign.JUSTIFY.toString = $estr;
simpleText_HAlign.JUSTIFY.__enum__ = simpleText_HAlign;
var simpleText_Selection = $hxClasses["simpleText.Selection"] = { __ename__ : true, __constructs__ : ["CHARACTER","WORD","LINE"] };
simpleText_Selection.CHARACTER = ["CHARACTER",0];
simpleText_Selection.CHARACTER.toString = $estr;
simpleText_Selection.CHARACTER.__enum__ = simpleText_Selection;
simpleText_Selection.WORD = ["WORD",1];
simpleText_Selection.WORD.toString = $estr;
simpleText_Selection.WORD.__enum__ = simpleText_Selection;
simpleText_Selection.LINE = ["LINE",2];
simpleText_Selection.LINE.toString = $estr;
simpleText_Selection.LINE.__enum__ = simpleText_Selection;
var simpleText_Hit = $hxClasses["simpleText.Hit"] = { __ename__ : true, __constructs__ : ["WITHIN","CLOSE"] };
simpleText_Hit.WITHIN = ["WITHIN",0];
simpleText_Hit.WITHIN.toString = $estr;
simpleText_Hit.WITHIN.__enum__ = simpleText_Hit;
simpleText_Hit.CLOSE = ["CLOSE",1];
simpleText_Hit.CLOSE.toString = $estr;
simpleText_Hit.CLOSE.__enum__ = simpleText_Hit;
...
simpleText__$SimpleText_AbstractLetter_$Impl_$.__name__ = ["simpleText","_SimpleText","AbstractLetter_Impl_"];
...
simpleText__$SimpleText_AbstractLetter_$Impl_$["char"] = function(this1) {
	return String.fromCharCode(this1.charCode);
};
...
simpleText__$SimpleText_AbstractRange_$Impl_$.__name__ = ["simpleText","_SimpleText","AbstractRange_Impl_"];
...
simpleText__$SimpleText_SimpleText_$Impl_$.__name__ = ["simpleText","_SimpleText","SimpleText_Impl_"];
simpleText__$SimpleText_SimpleText_$Impl_$.__properties__ = {set_tweenParam:"set_tweenParam",get_tweenParam:"get_tweenParam"};
	...
	while(pos1 < len1) {
		...
		default:
			if(spaceNo > f.spaces[count - 1]) {
				...
				var dxdW = dx + dW1;
				var _g3 = this1.fontStyle.hAlign;
				switch(_g3[1]) {
				case 0:
					px = dxdW;
					break;
	...
	case 0:
		...
		case 0:
			...
			if(letter != null) {
				...
				return String.fromCharCode(letter.charCode);
			} else {
				if(highlight) {
	...
	case 1:
		...
		case 0:
			...
			if(px > this1.x && px < this1.x + this1.width && py > this1.y && py < this1.y + this1.height) {
				...
				var pos1 = this1.pos;
				if(range1 != null) {
					var _g14 = range1.begin;
					var _g5 = range1.end + 1;
					while(_g14 < _g5) {
						var i3 = _g14++;
						letter4 = pos1[i3];
			...
			if(r1 != null) {
				if(r1.begin == null || r1.end == null) {
					...
					var this7 = { begin : r1.begin.j, end : r1.end.j};
					var r4 = this7;
					var str = "";
					var _g17 = r4.begin;
					var _g8 = r4.end + 1;
		...
		case 1:
			...
			if(px > this1.x && px < this1.x + this1.width && py > this1.y && py < this1.y + this1.height) {
				...
				if(r5 == null || r5.begin == null || r5.end == null) {
					...
					var this8 = { begin : r5.begin.j, end : r5.end.j};
					range2 = this8;
				}
				...
				var pos2 = this1.pos;
				if(range2 != null) {
					var _g19 = range2.begin;
					var _g10 = range2.end + 1;
					while(_g19 < _g10) {
						var i8 = _g19++;
						letter6 = pos2[i8];
			...
			if(highlight) {
				if(r1 == null || r1.begin == null || r1.end == null) {
					...
					var this9 = { begin : r1.begin.i, end : r1.end.i};
			...
			if(r1 != null) {
				if(!(r1.begin == null || r1.end == null)) {
					var this10 = { begin : r1.begin.j, end : r1.end.j};
					var r6 = this10;
					var str1 = "";
					var _g111 = r6.begin;
					var _g21 = r6.end + 1;
		...
		case 0:
			...
			if(px > this1.x && px < this1.x + this1.width && py > this1.y && py < this1.y + this1.height) {
				...
				if(j4 == l7) {
					...
					r7 = { begin : begin6, end : end6};
				}
			} else {
				r7 = null;
			}
			if(highlight) {
				if(r7 == null || r7.begin == null || r7.end == null) {
					this1.highLightRange = null;
				} else {
					var this11 = { begin : r7.begin.i, end : r7.end.i};
					this1.highLightRange = this11;
				}
			}
			var pos_7 = this1.pos;
			if(r7 != null) {
				if(r7.begin == null || r7.end == null) {
					return "";
				} else {
					var this12 = { begin : r7.begin.j, end : r7.end.j};
					var r8 = this12;
					var str2 = "";
					var _g113 = r8.begin;
					var _g23 = r8.end + 1;
		...
		case 1:
			...
			if(highlight) {
				if(r7 == null || r7.begin == null || r7.end == null) {
					...
					var this13 = { begin : r7.begin.i, end : r7.end.i};
					this1.highLightRange = this13;
				}
			}
			var pos_9 = this1.pos;
			if(r7 != null) {
				if(r7.begin == null || r7.end == null) {
					...
					var this14 = { begin : r7.begin.j, end : r7.end.j};
					var r9 = this14;
					var str3 = "";
					var _g115 = r9.begin;
					var _g25 = r9.end + 1;
...
simpleText__$SimpleText_SimpleText_$Impl_$.stringFromRange = function(this1,lr) {
	...
	if(lr != null) {
		if(lr.begin == null || lr.end == null) {
			...
			var this2 = { begin : lr.begin.j, end : lr.end.j};
			var r = this2;
			var str = "";
			var _g1 = r.begin;
			var _g = r.end + 1;
...
$hxClasses["westCountrySalsa.Contact"] = westCountrySalsa_Contact;
westCountrySalsa_Contact.__name__ = ["westCountrySalsa","Contact"];
westCountrySalsa_Contact.prototype = {
	content: null
	,txt: null
...
$hxClasses["westCountrySalsa.LatinoSundays"] = westCountrySalsa_LatinoSundays;
westCountrySalsa_LatinoSundays.__name__ = ["westCountrySalsa","LatinoSundays"];
westCountrySalsa_LatinoSundays.prototype = {
	content: null
	,txt: null
	,__class__: westCountrySalsa_LatinoSundays
};
var westCountrySalsa_MouseAndKey = function() {
	this.y = -1;
	this.x = -1;
	this.enable = true;
...
$hxClasses["westCountrySalsa.MouseAndKey"] = westCountrySalsa_MouseAndKey;
westCountrySalsa_MouseAndKey.__name__ = ["westCountrySalsa","MouseAndKey"];
westCountrySalsa_MouseAndKey.prototype = {
	txt: null
	,change: null
	,down: null
	,up: null
	...
	,keyDown: function(keyCode) {
		...
		if(keyCode == 8) {
			if(this.txt != null) {
				var tmp = HxOverrides.substr(this.txt.content,0,this.txt.content.length - 2);
				this.txt.content = tmp;
				this.txt.dirty = true;
			}
		}
	}
	,keyUp: function(keyCode) {
		...
		haxe_Log.trace(keyCode,{ fileName : "MouseAndKey.hx", lineNumber : 53, className : "westCountrySalsa.MouseAndKey", methodName : "keyUp"});
	}
	,pressListener: function(str) {
		haxe_Log.trace("pressed " + str + this.key,{ fileName : "MouseAndKey.hx", lineNumber : 56, className : "westCountrySalsa.MouseAndKey", methodName : "pressListener"});
		if(this.txt != null) {
			this.txt.content += str;
			this.txt.dirty = true;
		}
	}
	,__class__: westCountrySalsa_MouseAndKey
};
var westCountrySalsa_SalsaClasses = function() {
	this.content = "SALSA from 7.30\nSunday \n@ The Bell Inn, Bath\nThursday\n@ The Rose & Crown,\nHinton Charterhouse\n£5 entry\nSocial from 8pm";
	var this1 = { begin : 0, end : this.content.length};
	var fontStyle = { font : kha_Assets.fonts.Arimo_Bold, size : westCountrySalsa_SalsaClasses.size, color : westCountrySalsa_SalsaClasses.fontColor, alpha : 1., range : this1, dAdvanceX : 5., dAdvanceY : -4., hAlign : simpleText_HAlign.CENTRE};
	var this2 = { x : 0., y : 0., fontStyle : fontStyle, content : this.content, wrapWidth : 520, highLightColor : -1, highLightAlpha : 0.9, bgHighLightColor : -16777216, bgHighLightAlpha : 1., highLight : true};
	this2.dirty = true;
	this2._tweenParam = 1.;
	this.txt = this2;
};
$hxClasses["westCountrySalsa.SalsaClasses"] = westCountrySalsa_SalsaClasses;
westCountrySalsa_SalsaClasses.__name__ = ["westCountrySalsa","SalsaClasses"];
westCountrySalsa_SalsaClasses.prototype = {
	content: null
	,txt: null
	,__class__: westCountrySalsa_SalsaClasses
};
var westCountrySalsa_SalsaThursdays = function() {
	this.content = "SALSA THURSDAYS \n@ The Rose & Crown,\nHinton Charterhouse\n\nfrom 15th February\n\n£5 entry\n7.30pm Salsa lesson\nwith Justin\n\nSocial from 8pm";
	var this1 = { begin : 0, end : this.content.length};
	var fontStyle = { font : kha_Assets.fonts.Arimo_Bold, size : westCountrySalsa_SalsaThursdays.size, color : westCountrySalsa_SalsaThursdays.fontColor, alpha : 1., range : this1, dAdvanceX : 5., dAdvanceY : -4., hAlign : simpleText_HAlign.LEFT};
	var this2 = { x : 0., y : 0., fontStyle : fontStyle, content : this.content, wrapWidth : 520, highLightColor : -1, highLightAlpha : 0.9, bgHighLightColor : -16777216, bgHighLightAlpha : 1., highLight : true};
	this2.dirty = true;
	this2._tweenParam = 1.;
	this.txt = this2;
};
$hxClasses["westCountrySalsa.SalsaThursdays"] = westCountrySalsa_SalsaThursdays;
westCountrySalsa_SalsaThursdays.__name__ = ["westCountrySalsa","SalsaThursdays"];
westCountrySalsa_SalsaThursdays.prototype = {
	content: null
	,txt: null
	,__class__: westCountrySalsa_SalsaThursdays
};
var westCountrySalsa_Title = function() {
	this.content = "West Country Salsa";
	var this1 = { begin : 0, end : this.content.length};
	var fontStyle = { font : kha_Assets.fonts.Arimo_Bold, size : westCountrySalsa_Title.size, color : westCountrySalsa_Title.fontColor, alpha : 1., range : this1, dAdvanceX : 5., dAdvanceY : -4., hAlign : simpleText_HAlign.CENTRE};
	var this2 = { x : 0., y : 0., fontStyle : fontStyle, content : this.content, wrapWidth : 520, highLightColor : -1, highLightAlpha : 0.9, bgHighLightColor : -16777216, bgHighLightAlpha : 1., highLight : true};
	this2.dirty = true;
	this2._tweenParam = 1.;
	this.txt = this2;
};
$hxClasses["westCountrySalsa.Title"] = westCountrySalsa_Title;
westCountrySalsa_Title.__name__ = ["westCountrySalsa","Title"];
westCountrySalsa_Title.prototype = {
	content: null
	,txt: null
	,__class__: westCountrySalsa_Title
};
var westCountrySalsa_WestCountrySalsa2 = function() {
	this.localHi = 0;
	this.localWid = 0;
...
westCountrySalsa_WestCountrySalsa2.prototype = {
	...
	,setup: function() {
		...
		this.createText();
		this.layout();
		var mouseAndKey = new westCountrySalsa_MouseAndKey();
		mouseAndKey.change = $bind(this,this.checkTextHit);
		var contact_ = this.contactTxt;
		var thursday = this.thursdayTxt;
		var sunday = this.sundayTxt;
		if(this.scale == 1.) {
			tweenx909_TweenX.to(this,{ imgAlpha : 1.},null,null,null,null,null,null,null,null,{ fileName : "WestCountrySalsa2.hx", lineNumber : 46, className : "westCountrySalsa.WestCountrySalsa2", methodName : "setup"}).delay(0.5).time(0.8).ease(tweenxcore_Easing.quadIn);
			tweenx909_TweenX.to(this,{ val : 1.},null,null,null,null,null,null,null,null,{ fileName : "WestCountrySalsa2.hx", lineNumber : 47, className : "westCountrySalsa.WestCountrySalsa2", methodName : "setup"}).delay(0.72).time(0.65).ease(tweenxcore_Easing.quadIn).onUpdate(function() {
				simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(thursday,_gthis.val);
				simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(sunday,_gthis.val);
				thursday.fontStyle.alpha = _gthis.val;
				sunday.fontStyle.alpha = _gthis.val;
				contact_.fontStyle.alpha = _gthis.val;
			}).onFinish(function() {
				simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(thursday,1.);
				simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(sunday,1.);
				contact_.fontStyle.alpha = 1.;
				_gthis.tweening = false;
				_gthis.dirty();
			});
		} else {
			simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(this.contactTxt,1.);
			simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(this.thursdayTxt,1.);
			simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(this.sundayTxt,1.);
		}
		this.dirty();
	}
	,dh: null
	...
	,imgAlpha: null
	,createText: function() {
		var latinoSundays = new westCountrySalsa_LatinoSundays();
		this.sundayTxt = latinoSundays.txt;
		this.sundayTxt.fontStyle.alpha = -0.7;
		var sunday = this.sundayTxt;
		this.sundayTxt.fy = function(px,py,charWid,charHi) {
			return py + 50 * Math.sin(2 * (px + charWid / 2) * Math.PI / 180) + sunday.height * 2;
		};
		this.sundayTxt.fx = function(px1,py1,charWid1,charHi1) {
			return sunday.x;
		};
		simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(this.sundayTxt,0.);
		this.allTxt.push(this.sundayTxt);
		var salsaThursdays = new westCountrySalsa_SalsaThursdays();
		this.thursdayTxt = salsaThursdays.txt;
		var thursday = this.thursdayTxt;
		this.thursdayTxt.fy = function(px2,py2,charWid2,charHi2) {
			return py2 + 50 * Math.sin(2 * (px2 + charWid2 / 2) * Math.PI / 180) + thursday.height * 2;
		};
		this.thursdayTxt.fx = function(px3,py3,charWid3,charHi3) {
			return thursday.x + thursday.width;
		};
		simpleText__$SimpleText_SimpleText_$Impl_$.set_tweenParam(this.thursdayTxt,0.);
		this.thursdayTxt.fontStyle.alpha = -0.7;
		...
		this.contactTxt.fontStyle.alpha = 0.;
	...
	,checkTextHit: function(x,y) {
		...
		if(str != "") {
			haxe_Log.trace("hit " + Std.string(this.selection) + " = " + str,{ fileName : "WestCountrySalsa2.hx", lineNumber : 218, className : "westCountrySalsa.WestCountrySalsa2", methodName : "checkTextHit"});
			this.dirty();
		}
	}
	,update: function() {
	...
	,render: function(framebuffer) {
		if(Main.hi != this.localHi || Main.wid != this.localWid) {
			this.layout();
		}
		...
		g2.set_opacity(1.);
		if(this.scale > 0.2) {
			g2.set_opacity(this.imgAlpha);
			g2.drawScaledImage(this.img,this.imgX,this.dh + (this.imgAlpha - 1) * 10,this.img.get_width() * this.scale | 0,this.img.get_height() * this.scale | 0);
			g2.set_opacity(1.);
		} else {
		...
		while(_g < _g1.length) {
			var t = _g1[_g];
			++_g;
			if(t.fontStyle.alpha != 0) {
				simpleText__$SimpleText_SimpleText_$Impl_$.render(t,g2);
			}
		}
		g2.end();
	}
	,__class__: westCountrySalsa_WestCountrySalsa2
};
...
westCountrySalsa_SalsaClasses.size = 20;
westCountrySalsa_SalsaThursdays.fontColor = -9879039;
westCountrySalsa_SalsaThursdays.size = 20;
westCountrySalsa_Title.fontColor = -44528;
westCountrySalsa_Title.size = 22;
Main.main();
